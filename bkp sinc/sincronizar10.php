...
$Planilha10 = "planilhas/$pesquisador/Planta/maquina1.xls";

function editar10($Id, $N, $P, $K, $Ca, $Mg, $S, $Cu, $B) {
...
session_start();
$_SESSION['sincronizar'] = 'Todos os arquivos foram sincronizados com sucesso.';
