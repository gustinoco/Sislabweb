...
$id = (int) $_get['id'];
$solos = $daoSolo->listar_solo_com_id_boletim_usuario((int) $_GET['id'], $usuario);
$boletim = $daoBoletim->lista_boletim_edicao(id);
...
<body onload="focus();
    ...
    <DIV class="col-md-8">
<img class="img-responsive" src="../../../sislabweb/img/logo.png">
    </div>
...
<label>Cliente </label><?php echo $cliente->Nome; ?>
<label>Cliente </label><?php echo $cliente->Email; ?>
<label>Cliente </label><?php echo $cliente->Cpf; ?>
<label>Cliente </label><?php echo $cliente->Fone; ?>
