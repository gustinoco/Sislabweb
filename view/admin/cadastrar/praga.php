...
if(isset($_GET['id']) AND is_numeric($_GET['id'])){
    ...
    if($fotos){
      ...
      foreach ($fotos as $foto) {
          ...
          $src_t = DIR_T.$foto->descricao;
          $src_f = DIR_F.$foto->descricao;
          $imagens .= '<li><input type="checkbox" name="fotos[]" value="'.$foto->id.'">' ;
          $imagens .= "<img class='foto_do_menu' src= '$src_t'/></li>";    
      }//FIM WHILE
    }//FIM IF
}
?>
...
<div class="large-9 columns">
	...
	<form action="salvar_praga.php" method="post" onSubmit="return confere()" enctype="multipart/form-data">
		...
		<div class="large-5 columns">
			<!-- FOTOS -->
			<label>Selecione até 10 fotos.<i>(.jpg)</i></label>
			<input name="fotos[]" size="5" type=file multiple />
