    ...
    <div class="row">
        <div class="artsplantas">
            ...
            <div class="page-header">
                ...
                <center><h1>Livro de Registro de Plantas</h1></center>
            </div>
            ...
            <table  cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-condensed" id="livro_registro">
                ...
                <tbody>
                    ...
                    <form method="post" action="">
                        ...
                        <td><div>
                                <?php
                                $plantas = $daoSolo->listar_planta_idboletim((int) $res->Id);
                                foreach ($plantas as $res2) {
                        ...
                        <td><div>
                                <a class="btn btn-xs btn-warning center-block" href="../formularios/form_boletim_planta.php?id=<?php echo $res->Id; ?>">Boletim</a>                              
                                <br>
                                <a class="btn btn-xs btn-warning center-block" href="../plantas/digita_result_externos.php?id=<?php echo $res->Id; ?>">Resultados</a>                              
                        ...
                        if ($_SESSION['Permissao'] == "0") {
                            ...
                            <td><div>
                                    <br>
                                    <a onclick="confirmacao2(<?php echo $res->Id; ?>, '../formularios/salvar_formulario_planta.php')" class="btn btn-xs btn-danger"  value="Excluir" >Excluir</a>
                                </div></td><?php
                        }
                        ?>                             
